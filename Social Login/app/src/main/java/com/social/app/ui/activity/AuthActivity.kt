...
import com.social.app.databinding.AuthAcitivtyBinding
import com.social.app.ui.auth.fragment.LoginFragment
import com.social.app.ui.auth.fragment.SignupFragment
...
class AuthActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (GoogleSignIn.getLastSignedInAccount(this) != null) {
            load(SignupFragment::class.java).replace(false)
        } else {
