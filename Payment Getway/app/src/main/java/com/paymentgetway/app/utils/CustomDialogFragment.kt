...
import com.paymentgetway.app.databinding.CustomDialogLayoutBinding
import com.paymentgetway.app.databinding.PermissionsItemBinding
...
class CustomDialogFragment() : RationaleDialogFragment() {
    ...
    private val permissionMap = mapOf(Manifest.permission.READ_CALENDAR to Manifest.permission_group.CALENDAR,
        ...
        Manifest.permission.READ_MEDIA_IMAGES to Manifest.permission_group.STORAGE
    )
