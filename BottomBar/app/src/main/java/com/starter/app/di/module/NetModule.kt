...
object NetModule {
    ...
    @Singleton
    @Named(DiConstants.BITCOIN)
    internal fun provideRetrofit1(@Named(DiConstants.BITCOIN) okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder().baseUrl(URLFactory.provideHttpUrl1()).client(okHttpClient)
